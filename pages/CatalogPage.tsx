        ...
        {clinics.length === 0 ? (
          ...
          <div key={clinic.id} className="group bg-white rounded-[3rem] border-2 border-slate-100 overflow-hidden hover:border-blue-100 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] transition-all flex flex-col h-full">
            ...
            <div className="p-10 flex flex-col flex-grow">
               ...
               <div className="grid grid-cols-2 gap-6 mb-10 pt-8 border-t-2 border-slate-50">
                 <div>
               ...
               <button 
                 className="w-full bg-[#0f172a] text-white py-5 rounded-2xl font-black hover:bg-[#2563eb] transition-all text-xs uppercase tracking-[0.2em] shadow-xl active:scale-95"
